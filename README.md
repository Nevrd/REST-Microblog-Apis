...
https://img.shields.io/badge/PostgreSQL-15+-316192?style=flat&logo=postgresql
...
👨‍💻 Автор / Author: Nevrd | 🎂 17 лет / y.o. | 🕐 Go изучаю всего 4 месяца / Learning Go for 4 months
...
Миграции: нативные SQL-скрипты + golang-migrate
...
bash
docker run -d --name pg-microblog -e POSTGRES_PASSWORD=0404 -p 5432:5432 postgres:15
3. Примени миграции
bash
...
Формат JSON (создание/обновление):
...
Migrations: native SQL scripts + golang-migrate
...
JSON format (create/update):

json
{
  "content": "Your note text",
  "tag": "single_tag_for_now"
}
🐞 Known Bugs
